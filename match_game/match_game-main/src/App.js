...
class App extends Component {
  ...
  clickTab = tabletId => {
    this.setState({category: tabletId})
  }
  ...
  render() {
    const {isGameEnd, score, timer, imageUrl, category} = this.state
    const tumbNailList = imagesList.filter(
      ...
      <div className="main-container">
        <nav className="nav-container">
          ...
          <ul className="score-timer">
            <li className="score-description">
              <p>
                Score: <span className="score-view">{score}</span>
              </p>
            </li>
            <li>
              <p className="score-description">
                <img
                  ...
                  className="timer"
                />
                <p className="score-view">{timer} sec</p>
              </p>
            </li>
          </ul>
        </nav>
        <div className="background-container">
          {!isGameEnd && (
            <div className="game-running-container">
                ...
                {tabsList.map(eachTab => (
                  <li key={eachTab.tabId}>
                    <button
                      ...
                      className={`tab-color ${
                        category === eachTab.tabId ? 'highlited-text' : ''
                      }`}
                    >
                      {eachTab.displayText}
                    </button>
              ...
              <ul className="tabs-elemts-container">
                {tumbNailList.map(eachItem => (
                  <li key={eachItem.id}>
                    <button
                      className="image-button"
                      type="button"
                      onClick={() => this.clickImage(eachItem.thumbnailUrl)}
                    >
                      <img
          ...
          {isGameEnd && (
            <div className="game-over-container">
              <img
                ...
                alt="trophy"
              />
              <p className="score-des">YOUR SCORE</p>
